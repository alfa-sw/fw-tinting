...
// Phase Current (picco) during constans speed movement (= A x 10) 
...
#define PHASE_CURRENT_VALVE_STRONG  60 // 8.0 A  
//#define PHASE_CURRENT_VALVE_STRONG  80 // 8.0 A      
//#define HOMING_PHASE_CURRENT_VALVE  20 // 2.0 A  
// Holding Current (= A x 10) 
