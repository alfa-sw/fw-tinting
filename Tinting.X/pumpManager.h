...
extern unsigned char SingleStrokeColorSupplyDuckbill(void);
extern unsigned char HighResColorSupply(void);
extern unsigned char HighResColorSupplyDuckbill(void);
extern unsigned char ContinuousColorSupply(void);
extern unsigned char ContinuousColorSupplyDuckbill(void);
