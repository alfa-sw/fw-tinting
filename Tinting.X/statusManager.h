...
enum {
	...
	/* 15 */  TINTING_RISCALDATORE_ON_ST,
	/* 16 */  TINTING_HEATER_ON_ST,
	/* 17 */  TINTING_WATER_PUMP_ON_ST,
	/* 18 */  TINTING_BRUSH_ON_ST,
	/* 19 */  TINTING_ROTATING_TABLE_ON_ST, 
	/* 20 */  TINTING_PAR_RX,
	/* 21 */  TINTING_JUMP_TO_BOOT, 
	/* 22 */  TINTING_CLEANING_ST,
	/* 23 */   
	/* 24 */  
	/* 25 */   
	/* 26 */  
  ...
  /** Errors */
    /* 30 */  TINTING_BAD_PAR_HUMIDIFIER_ERROR = 30,
    /* 31 */  TINTING_TIMEOUT_ERROR,
    /* 32 */  TINTING_RH_ERROR,
    /* 33 */  TINTING_TEMPERATURE_ERROR,
    /* 34 */  TINTING_PUMP_SOFTWARE_ERROR_ST,
	/* 35 */  TINTING_PUMP_HOMING_ERROR_ST,
    /* 36 */  TINTING_VALVE_HOMING_ERROR_ST,
    /* 37 */  TINTING_TABLE_HOMING_ERROR_ST,
    /* 38 */  TINTING_PUMP_RESET_ERROR_ST,
    /* 39 */  TINTING_VALVE_RESET_ERROR_ST,
    /* 40 */  TINTING_TABLE_RESET_ERROR_ST,
    /* 41 */  TINTING_PUMP_SUPPLY_CALC_ERROR_ST_ST,
    /* 42 */  TINTING_PUMP_POS0_READ_LIGHT_ERROR_ST,
    /* 43 */  TINTING_PUMP_END_STROKE_READ_DARK_ERROR_ST,
    /* 44 */  TINTING_PUMP_HOMING_BACK_ERROR_ST,
    /* 45 */  TINTING_VALVE_HOMING_BACK_ERROR_ST,
    /* 46 */  TINTING_PUMP_OPEN_LOAD_ERROR_ST,
    /* 47 */  TINTING_VALVE_OPEN_LOAD_ERROR_ST,
    /* 48 */  TINTING_TABLE_OPEN_LOAD_ERROR_ST,
    /* 49 */  TINTING_PUMP_MOTOR_OVERCURRENT_ERROR_ST,
    /* 50 */  TINTING_VALVE_MOTOR_OVERCURRENT_ERROR_ST,
    /* 51 */  TINTING_TABLE_MOTOR_OVERCURRENT_ERROR_ST,
    /* 52 */  TINTING_TIMEOUT_TABLE_MOVE_ERROR_ST,
    /* 53 */  TINTING_TABLE_SEARCH_POSITION_REFERENCE_ERROR_ST,
    /* 54 */  TINTING_LACK_CIRCUITS_POSITION_ERROR_ST,
    /* 55 */  TINTING_TIMEOUT_SELF_LEARNING_PROCEDURE_ERROR_ST,
    /* 56 */  TINTING_SELF_LEARNING_PROCEDURE_ERROR_ST,
    /* 57 */  TINTING_TABLE_MOVE_ERROR_ST,
    /* 58 */  TINTING_TABLE_MISMATCH_POSITION_ERROR_ST,
    /* 59 */  TINTING_BAD_PAR_PUMP_ERROR,
    /* 60 */  TINTING_BAD_PAR_TABLE_ERROR,	
};
