...
enum {
  ...
  /** Errors */
    ...
    /* 59 */  TINTING_RH_ERROR_ST,
    /* 60 */  TINTING_TEMPERATURE_ERROR_ST,     
    /* 61 */  TINTING_PUMP_SOFTWARE_ERROR_ST,
    /* 62 */  TINTING_TABLE_SOFTWARE_ERROR_ST,
    /* 63 */  TINTING_BAD_PAR_HUMIDIFIER_ERROR_ST,
    /* 64 */  TINTING_BAD_PAR_PUMP_ERROR_ST,
    /* 65 */  TINTING_BAD_PAR_TABLE_ERROR_ST,
    /* 66 */  TINTING_BAD_PERIPHERAL_PARAM_ERROR_ST, 
    /* 67 */  TINTING_TABLE_HOMING_ERROR_ST,
    /* 68 */  TINTING_BRUSH_OPEN_LOAD_ERROR_ST,
    /* 69 */  TINTING_BRUSH_OVERCURRENT_THERMAL_ERROR_ST,
    /* 70 */  TINTING_NEBULIZER_OPEN_LOAD_ERROR_ST,
    /* 71 */  TINTING_NEBULIZER_OVERCURRENT_THERMAL_ERROR_ST,
    /* 72 */  TINTING_PUMP_OPEN_LOAD_ERROR_ST,
    /* 73 */  TINTING_PUMP_OVERCURRENT_THERMAL_ERROR_ST,
    /* 74 */  TINTING_RELE_OPEN_LOAD_ERROR_ST,
    /* 75 */  TINTING_RELE_OVERCURRENT_THERMAL_ERROR_ST, 
    /* 76 */  TINTING_GENERIC24V_OPEN_LOAD_ERROR_ST,
    /* 77 */  TINTING_GENERIC24V_OVERCURRENT_THERMAL_ERROR_ST,              
    /* 78 */  TINTING_PUMP_MOTOR_THERMAL_SHUTDOWN_ERROR_ST,
    /* 79 */  TINTING_VALVE_MOTOR_THERMAL_SHUTDOWN_ERROR_ST,
    /* 80 */  TINTING_TABLE_MOTOR_THERMAL_SHUTDOWN_ERROR_ST,
    /* 81 */  TINTING_PUMP_MOTOR_UNDER_VOLTAGE_ERROR_ST,
    /* 82 */  TINTING_VALVE_MOTOR_UNDER_VOLTAGE_ERROR_ST,
    /* 83 */  TINTING_TABLE_MOTOR_UNDER_VOLTAGE_ERROR_ST,
    /* 84 */  TINTING_EEPROM_COLORANTS_STEPS_POSITION_CRC_ERROR_ST,              
};
